...
import phoneImage from "../../../assets/matterclone.png";
import { matters, mattersitems } from "../../../constants";

const Matter = () => {
  const [activeIndex, setActiveIndex] = useState(0);

  return (
    <div className="bg-white pt-0 mt-0 px-4 md:px-10 pb-12 lg:pb-20">
      <div className="text-center max-w-4xl mx-auto mb-12">
        {matters.map((tool, idx) => (
